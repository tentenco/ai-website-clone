---
name: clone-website
description: Orchestrate evidence-driven reconstruction of one or more websites with measurable visual, responsive, interaction, asset, and motion fidelity. Use when the user asks to clone, replicate, rebuild, reverse-engineer, emulate, adapt, or combine website references, including pixel-perfect pages, video-led sites, parallax, scroll-scrub, canvas, and WebGL experiences.
---

# Clone Website

Reconstruct **$ARGUMENTS** from auditable evidence. Preserve a clean boundary
