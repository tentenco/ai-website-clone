...
---
<!-- AUTO-GENERATED from .claude/skills/audit-motion/SKILL.md. Do not edit directly. Run `node scripts/sync-skills.mjs` to regenerate. -->

Canonical bundled resources live under `.claude/skills/audit-motion/`. Resolve relative scripts and references from that directory.
